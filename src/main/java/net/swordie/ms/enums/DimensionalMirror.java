...
public enum DimensionalMirror {
    MU_LUNG_DOJO(0, "Mu Lung Dojo", "Challenge Mu Lung Dojo and see how strong you REALLY are.", 105, 0, 1207, new int[]{1082392, 1082393, 1082394}, false),
    EREVE_CONFERENCE_PAVILION(1, "Ereve Conference Pavilion", "The Maple Alliance has been formed at the Continental Conference. \nBattle the Black Mage in 'Black Heaven' and 'Heroes of Maple'!", 75, 0, 7998, new int[]{1142769, 1142804, 3015030, 3700350, 3017016}, false),
    ...
    GRAND_ATHENAEUM(6, "Grand Athenaeum", "Head to the Grand Athenaeum to get a glipse of the past.", 100, 0, 32670, new int[]{1122263, 2431892}, false),
    PARTY_QUEST_ENTRANCE(7, "Party Quest Entrance", "It's more fun when you play with friends! Create a party \nto participate in a special mission.", 50, 0, 7887, new int[]{1003762, 1022073, 1132013, 1022175, 1902048, 2432131}, true),
    ...
    FRIENDSTORY(9, "FriendStory", "Experience FriendStory, the first spin-off of MapleStory!", 100, 32707, 33041, new int[]{1182079, 3015119, 3010875, 2432776, 2432788}, false),
    ...
    ALISHAN(502, "Alishan", "Do you want to move to Alishan?", 33, 55234, 55255, new int[]{1202160, 2434004}, false),
    EVENT_HALL(503, "Event Hall", "Do you want to move to Event Hall?", 1, 0, 5399, new int[]{}, false),
    ...
    MOMIJIGAOKA(506, "Momijigaoka", "Do you want to move to Momijigaoka?", 13, 0, 7844, new int[]{}, false),
    ...
    MUSHROOM_SHRINE(509, "Mushroom Shrine", "Do you want to move to Mushroom shrine where strange stories are hidden.", 10, 0, 7017, new int[]{1102887, 2047983, 2047982, 2047981, 4001832}, false),
