...
public enum InHeader {
    ...
    NEBULITE_INSERT_REQUEST(894),
    SOCKET_CREATE_REQUEST(895),
    ...
    MOB_EXPLOSION_START(1020),
    MOB_LIFTING_END(1021),
    MOB_UPDATE_FIXED_MOVE_DIR(1022),
    MOB_CREATE_FIRE_WALK(1023),
    MOB_AFTER_DEAD_REQUEST(1024),
    MOB_UNK_1025(1025),
