# 32203 The nex Explorer, Mai : Maple Road | Snail Park
...
sm.sendNext("So, your name is #h0#, right? You have two options now. You can listen to some explanations about starting out, take a few small tests, get some free gifts, and become my new best friend in the entire world...")
