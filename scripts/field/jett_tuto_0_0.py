...
sm.hideUser(True)
sm.spawnNpc(9201274, 50, -150)
sm.showNpcSpecialActionByTemplateId(9201274, "summon", 0)
sm.spawnNpc(9201275, -50, -150)
sm.showNpcSpecialActionByTemplateId(9201275, "summon", 0)
...
sm.showNpcSpecialActionByTemplateId(9201275, "attack", 0)
...
sm.showNpcSpecialActionByTemplateId(9201274, "attack", 0)
sm.sendDelay(2000)
...
sm.moveNpcByTemplateId(9201274, True, 600, 100)
sm.sendDelay(2000)
...
sm.moveNpcByTemplateId(9201275, True, 600, 100)
sm.sendDelay(2000)


sm.removeNpc(9201274)
sm.removeNpc(9201275)
sm.warp(620100010, 0)
