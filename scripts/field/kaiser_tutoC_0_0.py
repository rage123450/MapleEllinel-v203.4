...
sm.moveNpcByTemplateId(3000103, False, 400, 100)
sm.moveNpcByTemplateId(3000104, False, 400, 100)
sm.showEffect("Effect/Direction9.img/effect/tuto/BalloonMsg0/3", 1200, 0, -120, 0, 3000103, False, 0)
sm.sendDelay(600)
