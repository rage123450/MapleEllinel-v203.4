...
sm.showEffect("Effect/Direction12.img/effect/tuto/BalloonMsg1/2", 900, 700, 50, 0, 0, True, 0)
sm.sendDelay(810)
...
sm.showEffect("Effect/Direction12.img/effect/tuto/BalloonMsg1/1", 900, 700, 50, 0, 0, True, 0)
sm.sendDelay(810)
...
sm.showEffect("Effect/Direction12.img/effect/tuto/BalloonMsg1/1", 1200, 700, 50, 0, 0, True, 0)
sm.sendDelay(1200)
...
sm.moveNpcByTemplateId(2159381, True, 350, 100)
...
sm.showEffect("Effect/Direction12.img/effect/tuto/BalloonMsg0/1", 1200, 700, 50, 0, 0, True, 0)
sm.sendDelay(900)
